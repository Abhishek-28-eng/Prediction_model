...
subjects = [
    ...
    "Drawing", "Sports", "Environmental Studies", "Algebra","Geometry","Computer", "Defence","Sanskrit",
]
...
# Save to CSV
df.to_csv("10th_std.csv", index=False)

print("Dataset created and saved as '10th_std.csv'")
